...
```{r loadFit, include = FALSE, echo = FALSE}
...
biomass indices, and to a lesser extent, commercial age data. 

The fits to biomass indices were good overall. Fits for all series
...
fits to these indices was not completely unexpected, as one was a fishery 
dependent commercial catch-rate series with underlying targeting behaviour, 
while the fishery independent Hecate Strait Assemblage survey had a fixed 
station design with very large survey blocks. There were no trends in the 
residuals for the historical CPUE series, but this is due to the 
time-varying catchability applied to that series. Finally, the Synoptic 
survey residuals were unbiased and did not exhibit any significant trends.
...
very small proportion of the overall complex and so we considered it a minor
issue.

F vs Effort plots

## Price flexibility model

Does this need a section or an appendix?
...
complex yield curves followed a similar pattern across the three stock areas 
(Figure 4). In all areas, the optimal fishing effort for the area led to a 
slightly higher optimal harvest rate for Dover sole when compared to the 
